...
#define IMG_MGMT_LOG_DEBUG(...) IGNORE(__VA_ARGS__)
#define IMG_MGMT_LOG_INFO(...) IGNORE(__VA_ARGS__)
#define IMG_MGMT_LOG_WARN(...) IGNORE(__VA_ARGS__)
#define IMG_MGMT_LOG_ERROR(...) IGNORE(__VA_ARGS__)
#define IMG_MGMT_LOG_CRITICAL(...) IGNORE(__VA_ARGS__)
#define IMG_MGMT_LOG_DISABLED(...) MODLOG_DISABLED(176, __VA_ARGS__)
